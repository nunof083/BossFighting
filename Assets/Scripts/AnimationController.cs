...
public class AnimationController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey("w") && Input.GetKey("left shift") && Input.GetButtonDown("Jump"))
        {
        ...
        {
            animator.SetBool("isJumpWalking", true);
        }
        else
        {
            animator.SetBool("isJumpWalking", false);
        }
        ...
        if (Input.GetKey("w") && Input.GetKey("d") && Input.GetButtonDown("Jump"))
        {
            animator.SetBool("isJumpWalkingRight", true);
        }
        else
        {
            animator.SetBool("isJumpWalkingRight", false);
        }
        ...
        if (Input.GetKey("w") && Input.GetKey("a") && Input.GetButtonDown("Jump"))
        {
            animator.SetBool("isJumpWalkingLeft", true);
        }
        else
        {
            animator.SetBool("isJumpWalkingLeft", false);
        }
